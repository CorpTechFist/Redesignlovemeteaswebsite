...
const slides = [
  {
    ...
    content: [
      ...
      '',
      'WE ADVOCATE THE USE OF NON-TOXIC, NON-INVASIVE TREATMENT METHODS AND SPREAD AWARENESS ABOUT MENTAL AND PHYSICAL HEALTH — THERE ARE ALWAYS ALTERNATIVES EVEN TO WELLNESS.',
      '',
      'OUR MISSION IS TO PROVIDE A SANCTUARY OF HEALING AND COMFORT THROUGH OUR TEAS, SKINCARE, OILS, BATH SALTS, AND CANDLES. EVERYONE DESERVES A HOLISTIC APPROACH TO HEALTH THAT HONORS THE WISDOM OF NATURE. WE BELIEVE IN THE POWER OF THESE TIME-HONORED HERBS TO BRING BALANCE AND VITALITY TO YOUR LIFE, AND YOUR JOURNEY TO WELLNESS STARTS HERE WITH US.',
      '',
